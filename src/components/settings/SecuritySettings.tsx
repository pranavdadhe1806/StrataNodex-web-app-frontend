    ...
    <div style={{ fontFamily: 'var(--font-main)' }}>
      ...
      <div style={{ marginBottom: 32 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
          <span style={{ color: 'var(--text-primary)', fontSize: 15, fontWeight: 500 }}>Two-factor authentication</span>
          <button
            onClick={toggle2FA}
            disabled={twoFaLoading}
            style={{
              width: 40, height: 22, borderRadius: 11, border: 'none', cursor: 'pointer',
              background: user?.twoFactorEnabled ? 'var(--accent)' : '#3A3F47',
        ...
        {user?.twoFactorEnabled && (
          <div style={{
            ...
            background: 'rgba(36,119,198,0.06)', color: 'var(--accent)', fontSize: 12, fontWeight: 500,
          }}>
      ...
      <div style={{ height: 1, background: 'var(--divider)', marginBottom: 32 }} />

      {/* ── Change password ── */}
      <div>
        <span style={{ color: 'var(--text-primary)', fontSize: 15, fontWeight: 500, display: 'block', marginBottom: 4 }}>Change password</span>
